...
**Module:** H1 — Platform  
**Loại:** ⚪ Tùy chọn  
**Mục đích:** Format nội dung cho Facebook cá nhân (plaintext). Chỉ xử lý format, không viết nội dung.

---

## Typography ASCII

Facebook không hỗ trợ markdown. Dùng ký tự ASCII:
...
| Thông tin bổ sung | Ngoặc đơn `()` | `(gấp đôi thời lượng)` |
...
Bài Facebook KHÔNG có heading phụ. Dùng `===` để chia 4-6 khổ lớn. Mỗi khổ là dòng suy luận liền mạch.
